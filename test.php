            ...
            <div class="employee-panel">
                <div class="custom-table-wrapper">
                    <table class="employee-table">
                        ...
                        <tbody>
                            <?php
                            $query = "SELECT e.name, e.department, u.biometric_rfid, u.facial_map, u.fingerprint_template 
                            ...
                            if ($res) {
                                while($row = $res->fetch_assoc()) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo $row['biometric_rfid'] ?? '--------'; ?></td>
                                        <td><?php echo $row['facial_map'] ? 'Registered' : '--------'; ?></td>
                                        <td><?php echo $row['fingerprint_template'] ? 'Registered' : '--------'; ?></td>
                                        <td>
...
enrollModal.addEventListener('show.bs.modal', function (event) {
    ...
    document.getElementById('hidden-emp-id').value = button.getAttribute('data-name'); 
